...
class SimpleWordGeneratorTool(Tool):
    ...
    description = """
    Generate simple Word documents from text content.
    
    This tool creates basic Word documents from text with simple formatting.
    Use this for quick document creation without complex structure.
    """
    ...
    def forward(self, title: str, content: str, filename: str) -> str:
        ...
        try:
            ...
            while i < len(lines):
                ...
                result = self._parse_markdown_line(line, doc)
                i += 1
